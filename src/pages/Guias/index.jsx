      ...
      <div className="flex h-full w-full flex-col items-center overflow-hidden bg-guide2 bg-cover bg-center">
        ...
        <div className="mb-10 mt-5 grid min-h-[1000px] w-[950px] items-center justify-center justify-items-center sm:flex sm:flex-col sm:gap-y-20 lg:grid lg:grid-cols-2 lg:grid-rows-3">
          <div className="text-center">
            <img
              src="/src/assets/images/Guides/g1.jpg"
              alt="Guia 1"
              loading="lazy"
              ...
              onClick={() =>
                openModal(
                  ...
                  '/src/assets/images/Guides/gopen1.jpg'
                )
              }
            />
          ...
          <div className="text-center">
            <img
              src="/src/assets/images/Guides/g2.jpg"
              alt="Guia 2"
              loading="lazy"
              className="col-start-1 row-start-1 mb-5 h-auto w-[400px] cursor-pointer"
              onClick={() =>
                openModal(
                  ...
                  '/src/assets/images/Guides/gopen2.jpg'
                )
              }
            />
            <span className="font-dm-serif-display text-2xl text-light-yellow">
          ...
          <div className="text-center">
            <img
              src="/src/assets/images/Guides/g3.jpg"
              alt="Guia 3"
              loading="lazy"
              className="col-start-1 row-start-1 mb-5 h-auto w-[400px] cursor-pointer"
              onClick={() =>
                openModal(
                  ...
                  '/src/assets/images/Guides/gopen3.jpg'
                )
              }
            />
            <span className="font-dm-serif-display text-2xl text-light-yellow">
          ...
          <div className="text-center">
            <img
              src="/src/assets/images/Guides/g4.jpg"
              alt="Guia 4"
              loading="lazy"
              className="col-start-1 row-start-1 mb-5 h-auto w-[400px] cursor-pointer"
              onClick={() =>
                openModal(
                  ...
                  '/src/assets/images/Guides/gopen4.jpg'
                )
              }
            />
            <span className="font-dm-serif-display text-2xl text-light-yellow">
          ...
          <div className="col-span-2 text-center">
            <img
              src="/src/assets/images/Guides/g5.jpg"
              alt="Guia 5"
              loading="lazy"
              className="col-start-1 row-start-1 mb-5 h-auto w-[400px] cursor-pointer"
              onClick={() =>
                openModal(
                  ...
                  '/src/assets/images/Guides/gopen5.jpg'
                )
              }
            />
            <span className="font-dm-serif-display text-2xl text-light-yellow">
