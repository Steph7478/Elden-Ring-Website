export const lagrimasDeCristal = [
  {
    ...
    img: 'src/assets/images/Items/L_fuerza.webp',
    description:
    ...
    location:
      'Sobre un cuenco al borde del acantilado en una colina cerca de la cabaña de Roderika en la Colina Tormentosa.',
  },
  {
    name: 'Lágrima de cristal de inteligencia',
    img: 'src/assets/images/Items/L_inteligencia.webp',
    description:
    ...
    location:
      'Desde el lugar de gracia "Camino a la mansión" en Liurnia (Oeste), baja con cuidado (y montado a caballo) por las rocas cercanas y ve al punto indicado en las imágenes para encontrarte la lágrima sobre un cuenco.',
  },
  {
    name: 'Lágrima de cristal de destreza',
    img: 'src/assets/images/Items/L_destreza.webp',
    description:
    ...
    location: 'Sobre un cuenco en una pequeña isla en Liurnia (Norte).',
  },
  {
    name: 'Lágrima de cristal de fé',
    img: 'src/assets/images/Items/L_fe.webp',
    description:
    ...
    location:
      'Rodeado de flores venenosas un poco más al norte de "Ruinas del bosque semihumano" en Península del Llanto.',
  },
  {
    name: 'Lágrima de cristal cerúleo',
    img: 'src/assets/images/Items/L_ceruleo.webp',
    description:
    ...
    location:
      'Como recompensa por derrotar al jefazo Avatar del Árbol Aureo en Liurnia (Oeste) y también al de Picos de los gigantes.',
  },
  {
    name: 'Lágrima de cristal carmesi',
    img: 'src/assets/images/Items/L_carmesi.webp',
    description:
    ...
    location:
      'En la Tercera iglesia de Márika, en Necrolimbo (Este). Encuentras otra igual en un cuenco junto al "Árbol Aureo pequeño" en las Afueras de la capital.',
  },
  {
    name: 'Lágrima de cristal verde derramada',
    img: 'src/assets/images/Items/L_verdederramada.webp',
    description:
    ...
    location: 'Junto al "Árbol Aureo pequeño" en Necrolimbo (Este).',
  },
]
