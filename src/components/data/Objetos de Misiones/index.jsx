export const objetosDeMisiones = [
  {
    ...
    location: 'Te lo da Tanith como parte de la historia de Rya.',
  },
  {
    ...
    effect:
      'Amnios de un vientre que gestaba una descendencia no deseada. Forma parte de la historia de Rya.',
    location:
      'Se encuentra en el "Templo de Eiglay" en la Mansión del Volcán, en el Monte Gelmir.',
  },
  {
    name: 'Collar de Rya',
    ...
    location:
      'Lo suelta Trasno Terrible al matarlo, aunque también puedes comprárselo por las buenas a cambio de 1.000 runas.',
  },
  {
    name: 'Uva Shabriri',
    ...
    effect:
      'Globo ocular amarillento y supurante de lo enfermizo. Tiene que ver con la historia de Hyetta.',
    location:
      'Después de matar a Edgar, tienes que recargar la zona viajando a un lugar de gracia y al volver ya te la encontrarás en el lugar del "accidente". Y lo mismo si no lo matas y luego acabas con su espíritu cuando te invada en Liurnia (Oeste).\n Junto a un espíritu en el Castillo de Velo Tormentoso después de haber derrotado al jefazo Godrick, el Injertado.\n En un cadáver en el sótano de las "Ruinas purificadas" en Liurnia (Este)',
  },
  {
    name: 'Carta de Irina',
    ...
    location: 'Te la da Irina al hablar con ella por primera vez.',
  },
  {
    ...
    location:
      'En una sección de la Capilla de la espera a la que solo se puede acceder cuando vuelves a esta zona usando una Llave de espada imbuida en uno de los portales de "Los cuatro campanarios" en Liurnia (Oeste).',
  },
  {
    ...
    location: 'Encuentras I en un cadáver en el Castillo de Velo Tormentoso.',
  },
]
