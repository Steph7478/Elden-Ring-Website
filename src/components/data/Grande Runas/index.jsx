export const grandeRunas = [
  {
    ...
    img: '/images/Items/Gran_Runa_de_Godrick.webp',
    description:
    ...
    effect:
      'Gran Runa de Godrick, errante de bendición.\n Aumenta todos los atributos.\n Consulta la parte final de la sección de Colina Tormentosa para más detalles sobre cómo activarla.',
    location:
      'Se consigue como recompensa por derrotar al jefe Godrick, el Injertado.',
  },
  {
    name: 'Gran Runa de los Nonatos',
    img: '/images/Items/Gran_Runa_de_los_Nonatos.webp',
    description:
    ...
    effect:
      'Se usa para perfeccionar el renacimiento.\n Sirve para restablecer las estadísticas, hablando con Rennala en el mismo lugar en el que luchaste contra ella',
    location:
      'Como recompensa por derrotar a la jefa Rennala, Reina de la Luna Llena.',
  },
  {
    name: 'Gran Runa de Rykard',
    img: '/images/Items/Gran_Runa_de_Rykard.webp',
    description:
    ...
    effect:
      'Gran Runa de Rykard, carente de bendición.\n Restaura PS al derrotar enemigos.\n Para activarla tienes que ir a la Torre sagrada occidental de Altus.',
    location:
      'Se consigue como recompensa por derrotar al jefe Rykard, señor de la Blasfemia.',
  },
  {
    name: 'Gran Runa de Radahn',
    img: '/images/Items/Gran_Runa_de_Radahn.webp',
    description:
    ...
    effect:
      'Gran Runa de Radahn, errante de bendición. Aumenta los PS, los PC y la resistencia máximos.\n Se activa en la Torre sagrada de Caelid, en Montedrago',
    location: 'Se consigue como recompensa por derrotar al jefe Radahn.',
  },
  {
    name: 'Gran Runa de Mohg',
    img: '/images/Items/Gran_Runa_de_Mohg.webp',
    description:
    ...
    effect:
      'Gran Runa de Mohg, carente de bendición. Otorga la bendición de la sangre a los espectros. Se activa en la Torre sagrada oriental de Altus.\n',
    location:
      'Se consigue como recompensa por derrotar al jefe Mohg, Señor de la Sangre.',
  },
  {
    name: 'Gran Runa de Malenia',
    img: '/images/Items/Gran_Runa_de_Malenia.webp',
    description:
    ...
    effect:
      'Gran Runa de Malenia, carente de bendición. Tras haber recibido daño, tus ataques recuperan PS. Se activa en la "Torre sagrada solitaria" de Leyndell.',
    location:
      'Se consigue como recompensa por derrotar a la jefa Malenia, la Espada de Miquella.',
  },
  {
    name: 'Gran Runa de Morgott',
    img: '/images/Items/Gran_Runa_de_Morgott.webp',
    description:
    ...
    effect:
      'Gran Runa de Morgott, carente de bendición. Aumenta considerablemente los PS máximos. Se activa en la Torre sagrada oriental de Altus.',
    location:
      'Se consigue como recompensa por derrotar al jefe Morgott, rey de los Augurios.',
  },
]
